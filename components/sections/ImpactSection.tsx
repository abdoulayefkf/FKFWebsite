...
export default function ImpactSection() {
  ...
  // ⭐ Premium section motion (consistent with Vision + SDG)
  ...
  return (
    <section ref={ref} className="relative py-24 overflow-hidden">
      ...
      <motion.div
        style={{ y, scale }}
        className="relative z-0 max-w-7xl mx-auto px-6"
      >
        ...
        <div className="text-center">
          ...
          <div className="inline-block bg-white backdrop-blur-sm rounded-2xl px-10 py-8 shadow-2xl mb-6">
            ...
            <p className="uppercase tracking-[0.25em] text-yellow-400 font-semibold md:text-1xl">
              Our Impact
            </p>
        ...
        <div className="grid md:grid-cols-4 gap-6 auto-rows-[280px]">
          ...
          <div className="relative rounded-2xl overflow-hidden transition-all duration-300 hover:scale-105">
            <Image src="/impact/impact-1.jpg" alt="Students Supported" fill className="object-cover" />
            <div className="absolute inset-0 bg-black/10" />
            <div className="absolute bottom-0 p-6 text-white">
              <p className="text-5xl font-bold text-yellow-400">500+</p>
          ...
          <div className="relative rounded-2xl overflow-hidden md:col-span-2 md:row-span-2 transition-all duration-300 hover:scale-105">
            <Image src="/impact/impact-featured.jpg" alt="Lives Impacted" fill className="object-cover" />
            <div className="absolute inset-0 bg-black/5" />

            <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-8">
              <p className="text-7xl font-bold text-yellow-400">1,200+</p>
              <h3 className="text-3xl font-semibold text-white mt-4">Lives Impacted</h3>
          ...
          <div className="relative rounded-2xl overflow-hidden hover:scale-105 transition-all duration-300">
            <Image src="/impact/impact-2.jpg" alt="Mentors" fill className="object-cover" />
            <div className="absolute inset-0 bg-black/10" />
            <div className="absolute bottom-0 p-6 text-white">
          ...
          {/* TILE 3 */}
          <div className="relative rounded-2xl overflow-hidden hover:scale-105 transition-all duration-300">
            <Image src="/impact/impact-3.jpg" alt="Programs" fill className="object-cover" />
            <div className="absolute inset-0 bg-black/10" />
            <div className="absolute bottom-0 p-6 text-white">
          ...
          {/* TILE 4 */}
          <div className="relative rounded-2xl overflow-hidden hover:scale-105 transition-all duration-300">
            <Image src="/impact/impact-4.jpg" alt="Partners" fill className="object-cover" />
            <div className="absolute inset-0 bg-black/10" />
            <div className="absolute bottom-0 p-6 text-white">
          ...
          {/* TILE 5 */}
          <div className="relative rounded-2xl overflow-hidden hover:scale-105 transition-all duration-300">
            <Image src="/impact/impact-5.jpg" alt="Communities" fill className="object-cover" />
            <div className="absolute inset-0 bg-black/10" />
            <div className="absolute bottom-0 p-6 text-white">
          ...
          {/* TILE 6 */}
          <div className="relative rounded-2xl overflow-hidden hover:scale-105 transition-all duration-300">
            <Image src="/impact/impact-6.jpg" alt="Mission Driven" fill className="object-cover" />
            <div className="absolute inset-0 bg-black/10" />
            <div className="absolute bottom-0 p-6 text-white">
          ...
          {/* TILE 7 */}
          <div className="relative rounded-2xl overflow-hidden hover:scale-105 transition-all duration-300">
            <Image src="/impact/impact-7.jpg" alt="Global Representation" fill className="object-cover" />
            <div className="absolute inset-0 bg-black/10" />
            <div className="absolute bottom-0 p-6 text-white">
              <p className="text-5xl font-bold text-yellow-400">100%</p>
          ...
          {/* TILE 8 */}
          <div className="relative rounded-2xl overflow-hidden hover:scale-105 transition-all duration-300">
            <Image src="/impact/impact-8.jpg" alt="Prestigious Engagements" fill className="object-cover" />
            <div className="absolute inset-0 bg-black/10" />
            <div className="absolute bottom-0 p-6 text-white">
              <p className="text-5xl font-bold text-yellow-400">100%</p>

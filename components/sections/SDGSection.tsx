...
export default function SDGSection() {
  return (
    <section className="py-24 bg-white -mt-25">
    ...
    />
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="uppercase tracking-[0.25em] text-amber-500 font-semibold">
          ...
          {sdgs.map((sdg) => (
            ...
            >
              <div className="relative h-[320px] w-full transition-all duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                ...
                {/* FRONT */}
                <div
                  className={`absolute inset-0 rounded-2xl ${sdg.color} text-white flex flex-col items-center justify-center p-6 [backface-visibility:hidden]`}
                >
                  <Image
                    src={sdg.icon}
                    alt={sdg.title}
                ...
                {/* BACK */}
                <div
                  className={`absolute inset-0 rounded-2xl ${sdg.color} text-white flex flex-col justify-center items-center p-6 [transform:rotateY(180deg)] [backface-visibility:hidden]`}
                >
